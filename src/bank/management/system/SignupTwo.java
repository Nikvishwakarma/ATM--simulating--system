...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        String uccupationValues[] = {"Student","Salaried","Self Empyoled","Bussiness","Retired","Other"};
        occupation = new JComboBox(uccupationValues);
       ...
       pincode.setBounds(100,590,200,30);
        ...
        ButtonGroup citizengroups = new ButtonGroup();
        citizengroups.add(ayes);
        citizengroups.add(ano); 
