...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        r3.setBounds(100,200,170,20);
        add(r3);
        
        r4 = new JRadioButton("Recurring Deposit Account");
        r4.setFont(new Font("Raleway",Font.BOLD,16));
        r4.setBackground(Color.WHITE);
        r4.setBounds(350,200,240,20);
        add(r4);
        ...
        pindetail .setBounds(100,368,300,20);
        add(pindetail );
        ...
        c2 = new JCheckBox("Internal Banking");
        ...
        c7 = new JCheckBox("I hereby declares that enterd details are correct to the best of my knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,13));
        c7.setBounds(100,600,610,30);
        add(c7);
